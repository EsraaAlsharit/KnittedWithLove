...
public class Shoping extends AppCompatActivity {
   ...
   // Cursor cursor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + TABLE_ITEM + " WHERE " + KEY_TYPE + "=? ", new String[]{type});
        ...
        public View getView(final int position, @Nullable View convertView, @NonNull final ViewGroup parent) {
            ...
            images.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                     ...
                     intent=new Intent(Shoping.this, Item.class);
...
//                    SQLiteDatabase DB = dbHelper.getWritableDatabase();
                  ...
                  //
                    ...
                    //if(r>0)
                        Toast.makeText(Shoping.this, "Added successfully!", Toast.LENGTH_LONG).show();
                   // else
